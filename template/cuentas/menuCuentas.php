  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= URL ?>cuentas/nuevo">Nuevo</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/2">Num_Cuenta</a></li>
            ...
            <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/6">UI Mov</a></li>
            <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/7"># Movtos</a></li>
            <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/8">Saldo</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= URL ?>cuentas/cuentasPdf">Descargar Pdf</a>
        </li>
      </ul>
