...
<?php require_once("template/partials/menu.php") ?>
	...
	<div class="container">
		...
		<div class="card">
					...
					<div class="mb-3">
						...
						<select class="form-select" name="id_cliente">
							<?php foreach ($this->clientes as $cliente) : ?>
								...
								<?= ($this->cuenta->id_cliente == $cliente->id)?'selected' : null?>disabled><?= $cliente->nombre . " " . $cliente->apellidos ?></option>
							<?php endforeach; ?>
						</select>
			...
			<a class="btn btn-secondary" role="button" href="<?= URL ?>cuentas">Volver</a>
			</form>
			</div>
		</div>
